            ...
            <div class="col-xl-6 col-lg-6 col-md-6 m-t-40">
              ...
              <div class="card" >
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td>€{{$creditsToBuy*$price->value}}</td>
                      </tr>
                      <tr>
                        ...
                        <td>€0</td>
                                      ...
                                      <tr>
                        <td><p>{{__('Tax')}} :</p></td>
                        <td>€{{$creditsToBuy*($tax/100)*$price->value}}</td>
                      </tr>
                      <tr>
                        <td><h4>{{__('Total Order')}} :</h4></td>
                        <td><h4>€{{ $creditsToBuy*$price->value +  $creditsToBuy*($tax/100)*$price->value }}</h4></td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <form action="{{route('checkout.file')}}" method="POST">
                    ...
                    <input type="hidden" name="creditsToBuy" value="{{$creditsToBuy}}" >
                    <input type="hidden" name="creditsForFile" value="{{$creditsForFile}}" >
